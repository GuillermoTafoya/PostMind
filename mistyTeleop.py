...
sys.path.append("D:\\Dev\\YOLO")
from yolov5 import detectImage
...
def main(args):
    ...
    #if detect:
    detector = detectFromStreaming.detector()#source = 'rtsp://' + cp_misty.ip + ':1936')
    ...
    while True:
        ...
        window["-IMAGE-"].update(data=imgbytes)#imgbytes)
